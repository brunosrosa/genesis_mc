...
## Decisão
Estabelecer o **LadybugDB** como a camada nativa de grafos local do SOULS, atuando ativamente como o **Proximity Agent (Agente de Proximidade)** governado pelo ecossistema Rust:
