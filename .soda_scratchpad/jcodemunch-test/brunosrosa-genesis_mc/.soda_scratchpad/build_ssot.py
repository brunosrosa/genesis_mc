...
ssot_injector = f'''use crate::cognition::sgr_synthesizer::{{SgrPayload, TerminalClassification, CannibalizationAction}};
use thiserror::Error;
...
with open('src-tauri/src/persist/ssot_injector.rs', 'w', encoding='utf-8') as f:
    f.write(ssot_injector)

print("Applied clean rewrite")
