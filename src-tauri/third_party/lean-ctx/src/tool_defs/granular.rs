        ...
        tool_def(
            ...
            json!({
                ...
                "properties": {
                    ...
                    "top_k": { "type": ["integer", "string"], "description": "Number of results (default: 10). Numeric strings are tolerated." },
        ...
        tool_def(
            ...
            json!({
                ...
                "properties": {
                    ...
                    "timeout": {
                        "type": ["integer", "string"],
                        "description": "Timeout in seconds (default: 30). Numeric strings are tolerated."
                    },
                    "action": {
                        "type": "string",
