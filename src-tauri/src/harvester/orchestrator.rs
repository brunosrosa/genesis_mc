...
impl HarvesterOrchestrator {
    ...
    async fn pipeline_core(
        ...
        *sandbox_out = Some(sandbox);
        ...
        // Amputado: A clonagem no host em git.rs ja realiza a clonagem recursiva (--recurse-submodules).
        // Executar o Git de submódulos secundário dentro do sandbox causava erros NtCreateDirectoryObject e asfixia.
