...
impl PurgeGuard {
    ...
    pub fn purge(sandbox: SandboxHandle, ramdisk: RamdiskHandle) {
        ...
        tracing::debug!("PurgeGuard: Iniciando limpeza atômica de recursos...");
        ...
        // D2: A função finaliza com (), e possíveis erros de SO no Drop 
        // são absorvidos pelas implementações internas de Drop que usam warn!/eprintln!.
    }
}
...
mod tests {
    ...
    async fn test_purge_happy_path() {
        ...
        PurgeGuard::purge(sandbox, ramdisk);
