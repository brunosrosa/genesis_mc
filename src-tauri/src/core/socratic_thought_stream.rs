...
/// Sink para runtime Tauri v2.
#[cfg(feature = "tauri-app")]
pub struct TauriSocraticThoughtSink {
    app_handle: tauri::AppHandle,
}

#[cfg(feature = "tauri-app")]
impl TauriSocraticThoughtSink {
...
#[cfg(feature = "tauri-app")]
impl SocraticThoughtSink for TauriSocraticThoughtSink {
    fn emit_thought(&self, payload: &SocraticThoughtPayload) -> Result<(), String> {
        use tauri::Emitter;
        self.app_handle
            .emit(SOCRATIC_THOUGHT_EVENT, payload)
            .map_err(|e| format!("Falha ao emitir {SOCRATIC_THOUGHT_EVENT} via Tauri: {e}"))
    }
}
